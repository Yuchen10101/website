...
The part selected is the right thigh mechanism (Figure 1.1). Its primary function is to facilitate jumping movements, achieved by the rapid return action of the cam and the torque of the torsion spring (Figure 1.2). For detailed explanations, please refer to a separate post.
...
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 60%; vertical-align: top;">
        <img src="/website/P5_Figure_11.png" alt="Overall Structure and Parts Selection" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 1.1: Overall Structure and Parts Selection
            </strong>
        </p>
    </div>
</div>
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 60%; vertical-align: top;">
        <img src="/website/P5_Figure_12.png" alt="Related Parts Layout" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 1.2: Related Parts Layout
            </strong>
            <br>
...
The original drawing is depicted in Figure 1.3. To facilitate the machining process design, the part is enlarged fourfold in subsequent analyses.
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 60%; vertical-align: top;">
        <img src="/website/P5_Figure_13.png" alt="Original Drawing of Thigh Part" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 1.3: Original Drawing of Thigh Part
            </strong>
        </p>
    </div>
</div>
...
In line with the requirements for structural manufacturability, the part has been improved, with the overall outcome displayed in Figure 2.1. Subsequently, a breakdown analysis of the part's iterative design is conducted.
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 70%; vertical-align: top;">
        <img src="/website/P5_Figure_21.png" alt="Overview of the Improved Part" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 2.1: Overview of the Improved Part
            </strong>
        </p>
    </div>
</div>
...
Figure 2.2 highlights the critical dimensions that require higher precision in red.<br>
...
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 70%; vertical-align: top;">
        <img src="/website/P5_Figure_22.png" alt="Dimensional Tolerance Setting" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 2.2: Dimensional Tolerance Setting
            </strong>
        </p>
    </div>
</div>
...
The parallelism requirements, indicated in blue in Figure 2.3, are associated with:
...
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 70%; vertical-align: top;">
        <img src="/website/P5_Figure_23.png" alt="Position Accuracy Setting" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 2.3: Position Accuracy Setting
            </strong>
        </p>
    </div>
</div>
...
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 70%; vertical-align: top;">
        <img src="/website/P5_Figure_24.png" alt="Chamfer Setting" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 2.4: Chamfer Setting
            </strong>
        </p>
    </div>
</div>
...
- Each hole, which must mate with shafts and other components, requires a high degree of surface roughness (Figure 2.5).
...
- The far-right plane, which is in contact with the lower leg part's plane, also necessitates a certain level of surface roughness to ensure it does not affect the lower leg part's rotation around its axis (Figure 2.6).
...
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 70%; vertical-align: top;">
        <img src="/website/P5_Figure_25.png" alt="Hole Roughness Setting" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 2.5: Hole Roughness Setting
            </strong>
        </p>
    </div>
</div>
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 70%; vertical-align: top;">
        <img src="/website/P5_Figure_26.png" alt="Plane roughness and Backing Groove Setting" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 2.6: Plane roughness and Backing Groove Setting
            </strong>
        </p>
    </div>
</div>
...
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 85%; vertical-align: top;">
        <p style="text-align: center;">
            <strong>
            Table 4.2: Machining Process Plan
            </strong>
        </p>
        <img src="/website/P5_Table_42.png" alt="Machining Process Plan" style="width: 100%;" class="hover-img"/>
    </div>
</div>

## 5. Dimension Chain Calculation: Accuracy Inspection
### 5.1 Inner Hole Sizes
Each hole is directly machined, and the comparison of processing requirements and processing process precision is shown in Figure 5.1, which meets the requirements.
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 60%; vertical-align: top;">
        <img src="/website/P5_Figure_51.png" alt="Hole Accuracy Inspection" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 5.1: Hole Accuracy Inspection: Comparison of Machining Requirements and Process Accuracy
            </strong>
        </p>
    </div>
</div>
...
The dimensional chain analysis for important dimensions is shown in Table 5.1, which meets the requirements.

<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 70%; vertical-align: top;">
        <img src="/website/P5_Figure_52.png" alt="Plane Accuracy Inspection" style="width: 100%;" class="hover-img"/>
        <p style="text-align: center;">
            <strong>
            Figure 5.2: Plane Accuracy Inspection: Comparison of Machining Requirements and Process Accuracy
            </strong>
        </p>
    </div>
</div>
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 75%; vertical-align: top;">
        <p style="text-align: center;">
            <strong>
            Table 5.1: Dimensional Chain Analysis
            </strong>
        </p>
        <img src="/website/P5_Table_51.png" alt="Dimensional Chain Analysis" style="width: 100%;" class="hover-img"/>
    </div>
</div>
