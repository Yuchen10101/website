...
**1. Desk Grasp**: This scenario simulates the task of grasping items on a desktop. The environment includes a variety of foods, fruits, and common daily items (Figure 1.1a).

**2. Shelf Grasp**: Designed to simulate the process of grabbing items from a shelf, this environment features various items such as beverage bottles, cans, and boxes. The complexity of this environment is intended to test the robot's recognition and grasping capabilities (Figure 1.1b).

**3. Pick and Place**: In this setup, multiple bins are used to test both grasping and placing actions. The robot must not only recognize and grasp an item but also place it in a specific location (Figure 1.1c).

<div style="text-align: center;">
    <br>
    <div style="display: inline-block; text-align: center; width: 35%; vertical-align: top;">
        <img src="/website/P2_Figure_11_a.png" alt="Desk Grasp" style="width: 100%;" class="hover-img"/>
        <p>(a)</p>
    </div>
    <div style="display: inline-block; text-align: center; width: 30%; vertical-align: top;">
        <img src="/website/P2_Figure_11_b.png" alt="Shelf Grasp" style="width: 100%;" class="hover-img"/>
        <p>(b)</p>
    </div>
</div>
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 40%; vertical-align: top;">
        <img src="/website/P2_Figure_11_c.png" alt="Pick and Place" style="width: 100%;" class="hover-img"/>
        <p>(c)</p>
        <p style="text-align: center;">
            <strong>Figure 1.1: Task Environment</strong> <br>
            (a) Desk Grasp <br>
            (b) Shelf Grasp <br>
            (c) Pick and Place
        </p>
...
<div style="text-align: center;">
    <div style="display: inline-block; text-align: center; width: 60%; vertical-align: top;">
        <img src="/website/P2_Figure_22.png" alt="Hand Mapping" style="width: 100%;" class="hover-img" />
    </div>
    <p style="text-align: center;">
        <strong>Figure 2.2: Hand Motion Mapping</strong> <br>
    </p>
</div>
...
<div style="text-align: center; margin: 20px 0;">
    <video id="SimVideo" controls muted style="width: 70%; max-width: 960px;" class="hover-img">
        <source src="/website/P2_Movie_21.mp4" type="video/mp4">
...
<div style="text-align: center; margin: 20px 0;">
    <video id="CamVideo" controls muted style="width: 70%; max-width: 960px;" class="hover-img">
        <source src="/website/P2_Movie_22.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
</div>
